...
private fun KvRow(
    ...
    Row(
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(2.dp)) {
            IconButton(onClick = onMoveUp) { Icon(Icons.Default.DragHandle, "Move Up") }
            IconButton(onClick = onMoveDown) { Icon(Icons.Default.DragHandle, "Move Down") }
            IconButton(onClick = onDuplicate) { Icon(Icons.Default.ContentPaste, "Duplicate") }
